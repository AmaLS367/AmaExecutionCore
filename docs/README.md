# AmaExecutionCore Documentation

This directory hosts technical specifications, architectural diagrams, and component breakdowns.
...
* **[Backtest And Replay Guide](backtest.md)**: Historical replay inputs, output shape, metrics, and mode boundaries.
